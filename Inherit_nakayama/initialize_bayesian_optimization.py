...
from my_robo.solver.initialize_bayesian_optimization import InitializeBayesianOptimization
...
def initialize_bayesian_optimization(objective_function, lower, upper, last_incumbents, last_incumbent_values, initial_design="init_random_uniform", num_iterations=30,
                          maximizer="random", acquisition_func="log_ei", model_type="gp_mcmc",
                          n_init=3, rng=None, output_path=None, gamma=None):
    """
    ...
    bo = InitializeBayesianOptimization(objective_function, lower, upper,
                              last_incumbents,last_incumbent_values,
                              acquisition_func, model, max_func,
                              initial_design = initial_design,
                              initial_points = n_init, rng = rng,
                              output_path = output_path, gamma = gamma)
